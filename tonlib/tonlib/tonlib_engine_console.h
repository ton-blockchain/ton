...
TONLIBJSON_EXPORT void const *tonlib_event_loop_wait(TonlibEventLoop *loop, double timeout);
...
TONLIBJSON_EXPORT void tonlib_response_await_suspend(TonlibResponse *response, void const *continuation);
...
TONLIBJSON_EXPORT char const *tonlib_response_get_error_message(TonlibResponse *response);
...
TONLIBJSON_EXPORT char const *tonlib_response_get_response(TonlibResponse *response);
...
// functions.
TONLIBJSON_EXPORT TonlibEngineConsole *tonlib_engine_console_create(TonlibEventLoop *loop, char const *config);
...
TONLIBJSON_EXPORT char const *tonlib_engine_console_get_error_message(TonlibEngineConsole *console);
...
TONLIBJSON_EXPORT TonlibResponse *tonlib_engine_console_request(TonlibEngineConsole *console, char const *query);
