...
class TL_writer {
 ...
 public:
  ...
  virtual std::string gen_nameof_function_begin(const std::string &class_name) const {
    return "";
  }
  virtual std::string gen_nameof_function_end(const std::string &class_name) const {
    return "";
  }
  ...
  virtual std::string gen_nameof_case(const tl::tl_combinator *t) const {
    return "";
  }
