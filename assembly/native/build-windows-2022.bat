...
-DLZ4_LIBRARIES=%third_party%\lz4\build\VS2022\liblz4\bin\x64_Release\liblz4_static.lib ^
-DMHD_FOUND=1 ^
...
-DOPENSSL_CRYPTO_LIBRARY=%third_party%\openssl\libcrypto.lib ^
-DOPENSSL_SSL_LIBRARY=%third_party%\openssl\libssl.lib ^
