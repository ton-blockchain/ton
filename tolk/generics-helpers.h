...
public:
  explicit GenericSubstitutionsDeduceForCall(const FunctionData* fun_ref);
  ...
  TypePtr auto_deduce_from_argument(const FunctionData* cur_f, SrcLocation loc, TypePtr param_type, TypePtr arg_type);
