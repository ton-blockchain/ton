...
TEST(Metrics, BlockProcessingMetricsRenderAndClamp) {
  ...
  EXPECT_EQ(
      ...
      "collation_ext_messages_total{chain=\"master\",result=\"ok\",outcome=\"skipped_duplicate\"} 0.000000\n"
      ...
      "collation_ext_messages_total{chain=\"master\",result=\"error\",outcome=\"skipped_duplicate\"} 0.000000\n"
      ...
      "collation_ext_messages_total{chain=\"shard\",result=\"ok\",outcome=\"skipped_duplicate\"} 0.000000\n"
      ...
      "collation_ext_messages_total{chain=\"shard\",result=\"error\",outcome=\"skipped_duplicate\"} 0.000000\n"
