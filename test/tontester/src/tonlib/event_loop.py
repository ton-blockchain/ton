...
class TonlibEventLoop:
    def __init__(self, tonlib: TonlibCDLL, event_loop: asyncio.AbstractEventLoop, threads: int = 1):
        self._tonlib = tonlib
        self._loop = tonlib.event_loop_create(threads)
        self._next_continuation_id = 1
        self._futures: dict[int, asyncio.Future[None]] = {}
        self._py_event_loop = event_loop
    ...
    def create_awaitable_future(self) -> tuple[int, asyncio.Future[None]]:
