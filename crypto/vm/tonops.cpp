...
void register_ton_config_ops(OpcodeTable& cp0) {
  ...
  cp0.insert(OpcodeInstr::mkfixedrange(0xf820, 0xf823, 16, 4, instr::dump_1c("GETPARAM "), exec_get_var_param))
      ...
      .insert(OpcodeInstr::mksimple(0xf826, 16, "BALANCE", std::bind(exec_get_param, _1, 7, "BALANCE")))
      .insert(OpcodeInstr::mksimple(0xf827, 16, "RANDSEED", std::bind(exec_get_param, _1, 6, "RANDSEED")))
