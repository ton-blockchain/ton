...
class FullNode : public td::actor::Actor {
 public:
  ...
  virtual void add_ext_msg_overlay(std::vector<adnl::AdnlNodeIdShort> nodes, std::vector<adnl::AdnlNodeIdShort> senders,
                                   int priority, std::string name, td::Promise<td::Unit> promise) = 0;
