...
class Collator final : public td::actor::Actor {
 ...
 private:
  ...
  bool process_mevton_external_messages(std::vector<MevtonBundle> bundles);
  bool convert_mevton_bundle_messages(td::Result<std::vector<std::pair<Ref<ExtMessage>, int>>> res);
