...
struct NotarizationObserved {
  ...
  bool operator==(const NotarizationObserved&) const;
  std::string contents_to_string() const;
};
...
struct FinalizationObserved {
  ...
  bool operator==(const FinalizationObserved&) const;
  std::string contents_to_string() const;
};
...
struct WaitForParent {
  ...
  bool operator==(const WaitForParent&) const;
  std::string contents_to_string() const;
};
...
struct StoreCandidate {
  ...
  bool operator==(const StoreCandidate&) const;
  std::string contents_to_string() const;
};
...
struct SaveCertificate {
  ...
  bool operator==(const SaveCertificate&) const;
  std::string contents_to_string() const;
};
