...
| GLOBAL_CONFIG_URL         | TON global configuration file. Mainnet - https://ton.org/global-config.json, Testnet - https://ton.org/testnet-global.config.json                                                         |     no     |                                                         |
| DEFAULT_GLOBAL_CONFIG_URL | Default global configuration URL used when GLOBAL_CONFIG_URL is not provided.                                                                                                              |     no     | https://api.tontech.io/ton/wallet-mainnet.autoconf.json |
