if (ANDROID AND NOT DEFINED TON_ANDROID_THIRD_PARTY_DIR)
  ...
  set(TON_ANDROID_NDK_BIN "${TON_ANDROID_NDK_ROOT}/toolchains/llvm/prebuilt/linux-x86_64/bin")
  if (NOT EXISTS "${TON_ANDROID_NDK_BIN}")
    message(WARNING "Android NDK bin path not found at ${TON_ANDROID_NDK_BIN}; adjust if host differs.")
  endif()
