    ...
    if (MSVC)
      ...
      if(NOT EXISTS "${SECP256K1_LIBRARY}")
          add_custom_command(
            ...
            COMMAND cmake -E env CFLAGS="/WX" cmake -A x64 -B build -DSECP256K1_ENABLE_MODULE_RECOVERY=ON -DSECP256K1_BUILD_EXAMPLES=ON -DBUILD_SHARED_LIBS=OFF
        ...
        message(STATUS "Use built secp256k1: ${SECP256K1_LIBRARY}")
      endif()
    elseif (EMSCRIPTEN)
      set(SECP256K1_BINARY_DIR ${CMAKE_CURRENT_SOURCE_DIR}/third-party/secp256k1)
      ...
      if(NOT EXISTS "${SECP256K1_LIBRARY}")
          add_custom_command(
              WORKING_DIRECTORY ${SECP256K1_SOURCE_DIR}
              COMMAND ./autogen.sh
              COMMAND ./configure -q --disable-option-checking --enable-module-recovery --prefix ${SECP256K1_BINARY_DIR} --with-pic --disable-shared --enable-static --disable-tests --disable-benchmark
              COMMAND make -j16
