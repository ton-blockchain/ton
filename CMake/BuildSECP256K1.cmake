...
if (NOT SECP256K1_LIB)
    if (WIN32)
      set(SECP256K1_LIB ${SECP256K1_BINARY_DIR}/src/libsecp256k1.lib)
    else()
      set(SECP256K1_LIB ${SECP256K1_BINARY_DIR}/src/libsecp256k1.a)
    endif()
    ...
    add_custom_command(
      ...
      COMMAND cmake ${SECP256K1_SOURCE_DIR} -DSECP256K1_ENABLE_MODULE_RECOVERY=ON -DSECP256K1_DISABLE_SHARED=ON
      COMMAND make
