...
if (NOT SECP256K1_LIB)
    if (WIN32)
      set(SECP256K1_LIB ${SECP256K1_BINARY_DIR}/blst.lib)
      set(SECP256K1_BUILD_COMMAND ${SECP256K1_SOURCE_DIR}/build.bat)
    else()
      set(SECP256K1_LIB ${SECP256K1_BINARY_DIR}/build/src/libsecp256k1.a)
      set(SECP256K1_BUILD_COMMAND "cmake . -DSECP256K1_ENABLE_MODULE_RECOVERY=ON -DSECP256K1_DISABLE_SHARED=ON; make")
    endif()

    file(MAKE_DIRECTORY ${SECP256K1_BINARY_DIR})
    add_custom_command(
      WORKING_DIRECTORY ${SECP256K1_BINARY_DIR}
      COMMAND ${SECP256K1_BUILD_COMMAND}
