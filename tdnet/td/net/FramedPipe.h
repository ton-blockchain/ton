...
constexpr size_t DEFAULT_MAX_FRAMED_MESSAGE_SIZE = 16536;

// Write a framed message to a ChainBufferWriter
// Format: [4-byte length][message data]
Status framed_write(ChainBufferWriter &writer, Slice message, size_t max_message_size = DEFAULT_MAX_FRAMED_MESSAGE_SIZE);
...
Result<size_t> framed_read(ChainBufferReader &reader, BufferSlice &dst, size_t max_message_size = DEFAULT_MAX_FRAMED_MESSAGE_SIZE);
